...
public class Distributor {
    ...
    /* Паросочетания  */
    private static ArrayList<Integer> XtoY = new ArrayList<>();         /* XtoY[студенты] */
    private static ArrayList<Integer> YtoX= new ArrayList<>();         /* YtoX[курсовые] */

    private static ArrayList<Boolean> vx= new ArrayList<>();          /* Была ли попытка назначить данному студенту курсовую vx[студенты] */
    private static ArrayList<Boolean> vy= new ArrayList<>();          /* Подходит ли курсовая для назначения кому-то vy[курсовые] */

    private static ArrayList<Integer> maxRow= new ArrayList<>();       /* Под какие баллы студент ищет курсовую */
    private static ArrayList<Integer> minCol= new ArrayList<>();       /* Компенсация при понижении верхней границы */
